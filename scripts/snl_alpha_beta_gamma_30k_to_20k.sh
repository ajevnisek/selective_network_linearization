...
export SAVEDIR=/storage/jevnisek/snl/outputs/alpha-beta-gamma/original_cifar100/$RELU_BUDGET_starts_from_30k/resnet18_in/
export OUTDIR=/storage/jevnisek/snl/outputs/alpha-beta-gamma/original_cifar100/$RELU_BUDGET/resnet18_in/
