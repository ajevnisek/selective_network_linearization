...
1. Build the docker:
```shell
docker build -t snl-amir:v10 -f docker/v10_onr_tiny_imagenet_greedier/Dockerfile .
docker tag snl-amir:v10 ajevnisek/snl-amir:v10
docker push ajevnisek/snl-amir:v10
```
