...
#export OUTDIR=/storage/jevnisek/snl/alternating_alphas_and_betas/freeze_alphas_and_weights_xavier_init/
export OUTDIR=/local_code/alternating_alphas_and_betas/freeze_alphas_and_weights_xavier_init/
