...
export OUTDIR=/storage/jevnisek/relu_autoencoder_one_channel/relu_autoencoder_one_channel_local/relu-layer-$LAYER_INDEX-block-$BLOCK_INDEX-subblock-$SUBBLOCK_RELU_INDEX-hiddendim-$HIDDEN_DIM
